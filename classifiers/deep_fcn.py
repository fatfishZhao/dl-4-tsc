...
class Classifier_DEEP_FCN:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        conv1 = keras.layers.Conv1D(filters=128, kernel_size=8, padding='same', strides=2)(input_layer)
        ...
        conv4 = keras.layers.Conv1D(filters=128, kernel_size=3, padding='same', strides=2)(conv3)
        ...
        conv6 = keras.layers.Conv1D(128, kernel_size=3, padding='same')(conv5)
